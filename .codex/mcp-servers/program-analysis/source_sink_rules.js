...
const RULES = [
  ...
  },
  {
    ...
    pattern: /\.(execute|executemany|raw)\s*\(\s*f['"]/g,
    cwe: "CWE-89",
  },
  {
    lang: "py",
    kind: "sink",
    id: "py.sql.execute_string_format",
    pattern:
      /\.(execute|executemany|raw)\s*\(\s*(['"])(?:(?!\2).)*\2\s*(\+|%|\.format\s*\()/g,
    cwe: "CWE-89",
  },
  ...
  },
  {
    ...
    pattern: /\.(Query|QueryRow|QueryContext|Exec|ExecContext)\s*\(\s*fmt\.Sprintf\s*\(/g,
    cwe: "CWE-89",
  },
